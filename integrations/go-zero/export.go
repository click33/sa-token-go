...
func NewSession(id string, storage Storage, prefix string) *Session   { return core.NewSession(id, storage, prefix) }
...
func NewOAuth2Server(storage Storage, prefix string) *OAuth2Server { return core.NewOAuth2Server(storage, prefix) }
...
func Login(loginID interface{}, device ...string) (string, error) { return stputil.Login(loginID, device...) }
...
func GetLoginIDNotCheck(tokenValue string) (string, error)          { return stputil.GetLoginIDNotCheck(tokenValue) }
func GetTokenValue(loginID interface{}, device ...string) (string, error) { return stputil.GetTokenValue(loginID, device...) }
...
func Disable(loginID interface{}, duration time.Duration) error     { return stputil.Disable(loginID, duration) }
...
func HasPermission(loginID interface{}, permission string) bool { return stputil.HasPermission(loginID, permission) }
...
func GetPermissionListByToken(tokenValue string) ([]string, error) { return stputil.GetPermissionList(tokenValue) }
func CheckRoleByToken(tokenValue string, role string) error          { return stputil.CheckRole(tokenValue, role) }
...
func GetSessionByToken(tokenValue string) (*Session, error)     { return stputil.GetSessionByToken(tokenValue) }
...
func RefreshAccessToken(refreshToken string) (*RefreshTokenInfo, error) { return stputil.RefreshAccessToken(refreshToken) }
