module github.com/sa-tokens/sa-token-go/examples/chi-example
...
require (
	...
	github.com/sa-tokens/sa-token-go/integrations/chi v0.2.1
...
replace github.com/sa-tokens/sa-token-go/integrations/chi => ../../../integrations/chi
