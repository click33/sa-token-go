module github.com/sa-tokens/sa-token-go/examples/echo-example
...
require (
	...
	github.com/sa-tokens/sa-token-go/integrations/echo v0.2.1
...
replace github.com/sa-tokens/sa-token-go/integrations/echo => ../../../integrations/echo
